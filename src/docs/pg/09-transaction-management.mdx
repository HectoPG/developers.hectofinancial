...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
  <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">실시간 거래 조회</h3>
    </div>
    <p className="text-gray-700">개별 거래의 상세 정보와 현재 상태를 실시간으로 확인</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-xl border border-green-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">거래대사</h3>
    </div>
    <p className="text-gray-700">일자별 전체 거래 내역을 조회하여 거래 데이터 검증</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">정산대사</h3>
    </div>
    <p className="text-gray-700">정산 예정 거래와 수수료 정보를 확인하여 정산 관리</p>
  </div>
</div>
