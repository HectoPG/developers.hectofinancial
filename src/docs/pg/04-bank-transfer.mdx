...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">실시간 결제</h3>
    </div>
    <p className="text-gray-700">뱅크페이 시스템을 통한 즉시 계좌이체, 실시간 승인 처리</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-xl border border-green-200">
    ...
    <p className="text-gray-700">국내 주요 은행 모두 지원, 인터넷뱅킹 및 모바일뱅킹 연동</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">현금영수증 자동발행</h3>
    </div>
    <p className="text-gray-700">결제 완료 시 현금영수증이 자동으로 발행되어 세무 처리 편리</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-6 rounded-xl border border-orange-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">안전한 인증</h3>
    </div>
    <p className="text-gray-700">은행 공동 인증서, 간편인증 등 다양한 보안 인증 방식 지원</p>
  </div>
</div>
...
계좌이체 연동을 완료했다면, 다른 결제 수단도 확인해보세요:
