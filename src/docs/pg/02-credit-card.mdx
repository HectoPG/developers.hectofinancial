...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="bg-gradient-to-r from-hecto-50 to-hecto-100 p-6 rounded-xl border border-hecto-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">다양한 카드사</h3>
    </div>
    <p className="text-gray-700">국민, 신한, 삼성, 현대, 하나, 우리, 롯데, BC, NH농협 등 주요 카드사 지원</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200">
    ...
    <p className="text-gray-700">ISP, 안심클릭, 앱카드 등 다양한 인증 방식으로 안전한 결제</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-xl border border-green-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">할부 결제</h3>
    </div>
    <p className="text-gray-700">2&#126;24개월 할부, 무이자 할부 등 다양한 할부 옵션 제공</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">정기 결제</h3>
    </div>
    <p className="text-gray-700">빌키(Billing Key) 서비스로 안전한 정기 결제 구현</p>
  </div>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="bg-green-50 border border-green-200 p-6 rounded-xl">
    ...
    <ul className="text-green-800 text-sm space-y-2">
      <li>• 정상 카드번호로 일시불 결제</li>
      <li>• 할부 결제 (2, 3, 6, 12개월)</li>
      <li>• 빌키 발급 후 정기결제</li>
      <li>• 부분취소 및 전체취소</li>
    </ul>
  </div>
...
신용카드 결제 연동을 완료했다면, 다른 결제 수단도 확인해보세요:
