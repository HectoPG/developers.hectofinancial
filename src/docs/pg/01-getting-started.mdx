...
<div className="bg-white border border-gray-200 p-8 rounded-xl my-8 shadow-sm">
  <div className="flex items-center justify-between">
    <div className="flex flex-col items-center text-center">
      <div className="w-14 h-14 bg-gradient-to-br from-hecto-500 to-hecto-600 rounded-full flex items-center justify-center text-white font-bold text-xl mb-3 shadow-lg border-2 border-white">1</div>
      <span className="text-sm font-semibold text-gray-800">결제 요청</span>
      <span className="text-xs text-gray-500 mt-1">가맹점→PG</span>
    </div>
    <div className="flex-1 h-1 bg-gradient-to-r from-hecto-300 to-hecto-400 mx-6 rounded-full"></div>
    <div className="flex flex-col items-center text-center">
      <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xl mb-3 shadow-lg border-2 border-white">2</div>
      <span className="text-sm font-semibold text-gray-800">결제창 표시</span>
      <span className="text-xs text-gray-500 mt-1">PG→고객</span>
    </div>
    <div className="flex-1 h-1 bg-gradient-to-r from-blue-300 to-green-300 mx-6 rounded-full"></div>
    <div className="flex flex-col items-center text-center">
      <div className="w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center text-white font-bold text-xl mb-3 shadow-lg border-2 border-white">3</div>
      <span className="text-sm font-semibold text-gray-800">정보 입력</span>
      <span className="text-xs text-gray-500 mt-1">고객 결제</span>
    </div>
    <div className="flex-1 h-1 bg-gradient-to-r from-green-300 to-purple-300 mx-6 rounded-full"></div>
    <div className="flex flex-col items-center text-center">
      <div className="w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-xl mb-3 shadow-lg border-2 border-white">4</div>
      <span className="text-sm font-semibold text-gray-800">승인 처리</span>
      <span className="text-xs text-gray-500 mt-1">카드사 승인</span>
    </div>
    <div className="flex-1 h-1 bg-gradient-to-r from-purple-300 to-emerald-300 mx-6 rounded-full"></div>
    <div className="flex flex-col items-center text-center">
      <div className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center text-white font-bold text-xl mb-3 shadow-lg border-2 border-white">5</div>
      <span className="text-sm font-semibold text-gray-800">결과 통보</span>
      <span className="text-xs text-gray-500 mt-1">PG→가맹점</span>
    </div>
  </div>
</div>
