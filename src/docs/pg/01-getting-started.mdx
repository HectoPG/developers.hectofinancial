...
<ConfigCard
  ...
  value="tbgw.settlebank.co.kr"
  required={true}
/>

<ConfigCard
  title="API 서버 IP (테스트베드)"
  type="IP Address"
...
<ConfigCard
  ...
  value="14.34.14.25 (Primary), 61.252.169.58 (Secondary)"
...
<ConfigCard
  ...
  value="14.34.14.21 (Primary), 61.252.169.53 (Secondary)"
  note="취소 및 기타 API 서비스용 IP입니다."
/>
...
<ConfigCard
  ...
  value="pgSettle30y739r82jtd709yOfZ2yK5K"
  required={true}
...
- [📚 인터랙티브 API 문서](/docs/api) - 모든 API를 한눈에 보고 테스트해보세요
