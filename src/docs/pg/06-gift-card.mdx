...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="bg-gradient-to-r from-pink-50 to-pink-100 p-6 rounded-xl border border-pink-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">다양한 상품권</h3>
    </div>
    <p className="text-gray-700">게임, 도서, 문화상품권 등 6개 브랜드 상품권 지원</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">간편 결제</h3>
    </div>
    <p className="text-gray-700">상품권 번호와 PIN 입력만으로 간단한 결제</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-xl border border-green-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">실시간 처리</h3>
    </div>
    <p className="text-gray-700">즉시 잔액 확인 및 결제 승인 처리</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200">
    ...
    <p className="text-gray-700">상품권 유효성 검증 및 중복 사용 방지</p>
  </div>
</div>
...
상품권 결제 연동을 완료했다면, 다른 결제 수단도 확인해보세요:
...
<div className="bg-gray-50 p-6 rounded-xl text-center my-8">
  <p className="text-gray-600 mb-4">
    상품권 결제 연동에 대한 추가 문의사항이 있으시나요?
  </p>
  <div className="flex justify-center space-x-4">
    <a href="mailto:support@hectofinancial.com" className="inline-flex items-center px-4 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-colors">
      📧 기술지원 문의
    </a>
