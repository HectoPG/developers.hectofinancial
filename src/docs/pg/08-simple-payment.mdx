...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">빠른 결제</h3>
    </div>
    <p className="text-gray-700">간편한 인증으로 빠른 결제 완료, 복잡한 카드 정보 입력 불필요</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-xl border border-green-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">다양한 브랜드</h3>
    </div>
    <p className="text-gray-700">페이코, 카카오페이, 네이버페이, 삼성페이 등 주요 간편결제 지원</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">복합 결제</h3>
    </div>
    <p className="text-gray-700">포인트, 쿠폰, 카드 등 다양한 결제 수단을 조합하여 사용</p>
  </div>
  ...
  <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-6 rounded-xl border border-orange-200">
    <div className="flex items-center mb-3">
      ...
      <h3 className="text-lg font-semibold text-gray-900">인증/승인 분리</h3>
    </div>
    <p className="text-gray-700">하이브리드 방식으로 인증과 승인을 분리한 유연한 결제 프로세스</p>
  </div>
</div>
