...
<DocParameterCard
  ...
  type="string"
  required={false}
  description="거래상태코드 (거래 없음시 null)"
  example="null"
/>
...
<DocParameterCard
  ...
  type="string"
  required={false}
  description="헥토파이낸셜 거래번호 (거래 없음시 null)"
  example="null"
/>
...
<DocParameterCard
  ...
  type="string"
  required={false}
  description="상점주문번호 (거래 없음시 null)"
  example="null"
/>
