...
export const documentationConfig: CategoryConfig[] = [
  {
    ...
    documents: [
      ...
      },
      {
        ...
        title: '거래 관리',
        path: '/docs/pg/transaction-management',
        category: 'PG 결제',
      ...
      },
      {
        ...
        title: '개발자 참조',
        path: '/docs/pg/developer-reference',
        category: 'PG 결제',
